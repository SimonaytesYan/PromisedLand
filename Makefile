RELEASE_FLAGS = -O2 -std=c++2a -fsanitize=address,undefined
...
compile: create_folders $(OBJ)RenderTarget.o $(OBJ)Utils.o $(OBJ)CellInterlayer.o $(OBJ)CellManager.o $(OBJ)CellView.o
	$(COMPILER) -fPIE $(FLAGS) $(SFML_FLAGS) $(SRC)main.cpp $(OBJ)RenderTarget.o $(OBJ)Utils.o $(OBJ)CellInterlayer.o $(OBJ)CellManager.o $(OBJ)CellView.o -o $(ELF_FILE)

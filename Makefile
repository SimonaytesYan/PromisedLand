...
$(OBJ)RenderTarget.o: $(SRC)Utils/RenderTarget.cpp
	$(COMPILER)  $(FLAGS) -c $(SRC)Utils/RenderTarget.cpp $(SFML_FLAGS) -o $(OBJ)RenderTarget.o

$(OBJ)Utils.o: $(SRC)Utils/Utils.cpp
	$(COMPILER) $(FLAGS) -c $(SRC)Utils/Utils.cpp -o $(OBJ)Utils.o

$(OBJ)CellInterlayer.o: $(SRC)Interlayers/CellInterlayer.cpp
	$(COMPILER) $(FLAGS) -c $(SRC)Interlayers/CellInterlayer.cpp -o $(OBJ)CellInterlayer.o

$(OBJ)CellManager.o: $(SRC)Managers/CellManager.cpp
	$(COMPILER) $(FLAGS) -c $(SRC)Managers/CellManager.cpp -o $(OBJ)CellManager.o

$(OBJ)CellView.o: $(SRC)Graphics/CellView/CellView.cpp
	$(COMPILER) $(FLAGS) -c $(SRC)Graphics/CellView/CellView.cpp -o $(OBJ)CellView.o

...
ELF_FILE = $(BIN)run
OBJECTS  = $(OBJ)SavingScore.o $(OBJ)GameCycle.o $(OBJ)Menu.o $(OBJ)RenderTarget.o $(OBJ)Utils.o $(OBJ)CellInterlayer.o $(OBJ)CellManager.o $(OBJ)CellViewGroup.o $(OBJ)CellKeeper.o $(OBJ)MapSaveLoad.o

...
ELF_FILE = $(BIN)run
OBJECTS  = $(OBJ)SavingScore.o $(OBJ)GameCycle.o $(OBJ)Menu.o $(OBJ)RenderTarget.o $(OBJ)Utils.o $(OBJ)CellInterlayer.o $(OBJ)CellManager.o $(OBJ)CellViewGroup.o $(OBJ)CellKeeper.o $(OBJ)MapSaveLoad.o $(OBJ)MapWidget.o
...
$(OBJ)SavingScore.o: create_folders $(SRC)Utils/SavingScore.cpp
	$(COMPILER) -c $(FLAGS) $(SRC)Utils/SavingScore.cpp -o $(OBJ)SavingScore.o
